...
import com.chandru.My_shop.service.AdminService;
...
public class AdminServiceImpl implements AdminService {
	...
	@Override
	public String addProduct(@Valid Product product, BindingResult result, MultipartFile picture, HttpSession session,
			ModelMap map) {
		...
		if (customer == null) {
			...
			if (customer.getRole().equals("ADMIN")) {
				...
				if (result.hasErrors())
					...
					File file = new File("src/main/resources/static/images", product.getImagePath());
					if (!file.isDirectory())
						file.mkdir();
